  ...
  return (
    <Link className="toon-card" to={`/series/${toon.id}`}>
      <div className="toon-card__thumb">
        <img src={assetUrl(toon.mainThumbnail)} alt={toon.title} loading="lazy" />
        <span className="toon-card__badge">{toon.episodeCount}화</span>
      </div>
      <div className="toon-card__body">
        <h3 className="toon-card__title">{toon.title}</h3>
